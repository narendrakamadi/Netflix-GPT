            ...
            <div className="max-w-7xl mx-auto px-4 md:px-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="hover:text-white transition-colors">Shows</a></li>
                ...
                <div className="border-t border-gray-700 pt-8">
                    <p className="text-sm mb-4">
                        Experience entertainment like never before with Netflix GPT. Our AI-powered platform learns your preferences and delivers personalized movie and TV show recommendations tailored just for you.
                    </p>
                    <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                        <p className="text-xs">© 2026 Netflix GPT. All rights reserved.</p>
                        <p className="text-xs">Made with ❤️ by Narendra Kamadi</p>
                    </div>
                </div>
            </div>
        </footer>
