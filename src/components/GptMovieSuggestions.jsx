...
const sampleSuggestions = [
	{
		...
		overview: "A detective unravels a cold case that points back to her own past.",
		poster:
	...
	},
	{
		...
		overview: "A deep space relay finds a message that changes humanity's future.",
		poster:
			"https://images.unsplash.com/photo-1495562569060-2eec283d3391?auto=format&fit=crop&w=600&q=80",
	},
	{
		id: 3,
    ...
    },
	{
		...
		overview: "A young artist brings constellations to life with a secret ink.",
		poster:
    ...
    },
	{
		...
		match: 82,
		genres: ["Comedy", "Drama"],
		overview: "A retired projectionist saves a neighborhood cinema from closure.",
		poster:
